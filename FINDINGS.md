...
1/8 = 12.5%" — is a look-ahead artifact of how the buckets were built, not a
...
the market's **outcome**. 5 of the 8 "refiles" had **no prior CRL**; they were
filed into a "refile" bucket *because they failed*. Strip the leakage and the
pre-identifiable refile rate is **1/3 = 33%, Wilson 95% [6%, 79%], n = 3.**

Two honest consequences, and no more: (1) the dramatic 12.5%-vs-100% spread is
...
- **(b) Selection / survivorship.** Markets exist only for decisions retail
  ...
  apparent failure rate and is why 64% ≪ 83% (U6).
- **(c) By-date vs ever.** 21/33 on time, **22/33 ever** (S2, fig8). The refile
  cohort: 1/3 on-time *and* 1/3 ever in this n; the CMC bucket 1/8 on-time but
  **2/8 ever** — CMC problems are often curable, just not by the market's date.
